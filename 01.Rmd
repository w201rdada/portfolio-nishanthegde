...
form that can be reasoned with. [@murdoch_beyond] This would allow for the computation of extracted information from scripts so that this information can be accessed and analyzed in a database system.
