...
The success of an entertainment studio is based on finding content that is unique and original. This process usually starts with a script being pitched to a studio. It is normal for studios to receive hundreds of scripts per week from content creators and writers. If the studio likes what it sees it greenlights the project and decides to fund it. 
